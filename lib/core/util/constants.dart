...
const String updateUserUrl = '$baseUrl/update';
const String updateLinkUrl = '$baseUrl/links';
...
const kYellowColor = Color(0xFFFFD60A);
const kLightPinkColor = Color(0xFFFFF0F0);
